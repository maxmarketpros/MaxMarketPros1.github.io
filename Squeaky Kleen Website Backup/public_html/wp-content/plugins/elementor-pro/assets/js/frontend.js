...
class _default extends elementorModules.frontend.handlers.Base {
  ...
  onElementChange(propertyName) {
    ...
    const propertyMatches = propertyName.match('.*?(motion_fx|_normal_transform|_hover_transform)');

    if (propertyMatches) {
      const instanceName = propertyMatches[0].match('(_normal_transform|_hover_transform)') ? 'motion_fx' : propertyMatches[0];
